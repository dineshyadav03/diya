...
- The API listens on localhost only, requires an access token, checks Host and Origin, and rejects an over-size body (413); 702 tests pass on Windows (as of 2026-09-25).
